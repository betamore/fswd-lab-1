...
describe('fizzBuzz', function() {
    ...
    it('should be ["FizzBuzz", 1, 2, "Fizz", 4] for 5', function() {
        fizzBuzz(5).should.deep.equal(['FizzBuzz', 1, 2, 'Fizz', 4]);
    });

    it('should be ["FizzBuzz", 1, 2, "Fizz", 4, "Buzz"] for 6', function() {
        fizzBuzz(6).should.deep.equal(['FizzBuzz', 1, 2, 'Fizz', 4, 'Buzz']);
    });
